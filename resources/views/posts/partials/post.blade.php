    ...
    <div class="flex justify-between align-center">
        ...
        <div>
            ...
            <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultDots">
                    <li>
                        <form action="#" method="POST" class="px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            @csrf
                            <button type="submit" class="edit flex justify-start items-center">
                    ...
                    <li>
                        <form action="{{ route('posts.destroy', $post) }}" method="POST" class="px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white">
                            @csrf
                            @method('DELETE')
